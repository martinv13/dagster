...
You can start writing assets in `tmp_project/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `tmp_project_tests` directory and you can run tests using `pytest`:

```bash
pytest tmp_project_tests
```
